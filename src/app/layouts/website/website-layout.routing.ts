...
export const WebsiteLayoutRoutes: Routes = [
  ...
  {path: 'staffing-consulting', component: SdoComponent, data: {title: 'JKC Solutions - Software development Outsourcing | Staffing | weboxapp', content: 'weboxapp, Weboxapps, Software Development, Outsourcing, IT Staffing, Staffing'}},
